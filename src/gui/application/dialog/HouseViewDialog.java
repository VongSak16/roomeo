 ...
 * * @author SAK
 */
public class HouseViewDialog extends javax.swing.JDialog {
    ...
    public HouseViewDialog(JFrame parent, FormHouse parentForm, House house) {
        super(parent, true);
        ...
        cboAvailability.addItem(currentHouse.getAvailability());
