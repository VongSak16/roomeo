 ...
 * * @author SAK
 */
public class RentalViewDialog extends javax.swing.JDialog {
    ...
    public RentalViewDialog(JFrame parent, Room room) {
        super(parent, true);
    ...
    private void initComponents() {
        ...
        btnSelectPhoto.setText("Photo Rental");

        txtfPrice.setEditable(false);

        jLabel4.setText("Rental Photo");
