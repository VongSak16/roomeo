...
public class Menu extends JPanel {
    ...
    private final String headerName = "Roomeo";
...
//        this.add(headerForm);
        ...
        ImageIcon originalIcon = new ImageIcon(getClass().getResource("/gui/icon/png/logo.png"));
        Image scaledImage = originalIcon.getImage().getScaledInstance(64, 64, java.awt.Image.SCALE_SMOOTH);
